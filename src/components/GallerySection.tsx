    ...
    >
      ...
      <Reveal>
        <div className="relative mb-3 aspect-5/6 overflow-hidden rounded-2xl border-4 border-white shadow-2xl">
          ...
          />
          <div className="pointer-events-none absolute top-3 right-3 flex items-center gap-1.5 rounded-full bg-black/55 px-3 py-1.5 text-[10px] tracking-wider text-white">
            <Icon name="expand" size={12} /> Ketuk untuk perbesar
          </div>
          <div className="pointer-events-none absolute right-0 bottom-0 left-0 bg-gradient-to-t from-black/65 to-transparent px-4 pt-8 pb-3">
            <p className="font-cormorant text-base italic text-white/95">
      ...
      >
        ...
        <p className="lb-hint">
          {GALLERY[lbIndex].caption} · geser atau gunakan tombol panah · ESC
          untuk menutup
        </p>
      </div>
    </section>
