  ...
  return (
    <>
      ...
      >
            ...
            <Reveal variant="left">
              <figure className="relative flex w-full flex-col items-center">
                ...
                <figcaption className="flex flex-col items-center gap-1.5">
                  ...
                  <a
                    href={`https://www.instagram.com/${WEDDING.bride.instagram}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="mt-2 inline-flex items-center gap-1.5 rounded-full border border-sage-200 bg-ivory-100 px-3 py-1 text-[11px] text-sage-700 transition hover:bg-sage-100 active:scale-95"
                  >
                    <Icon name="instagram" size={12} />
                    <span>@{WEDDING.bride.instagram}</span>
                  </a>
                </figcaption>
              </figure>
            </Reveal>
            ...
            <Reveal variant="right">
              <figure className="relative flex w-full flex-col items-center">
                ...
                <figcaption className="flex flex-col items-center gap-1.5">
                  ...
                  <a
                    href={`https://www.instagram.com/${WEDDING.groom.instagram}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="mt-2 inline-flex items-center gap-1.5 rounded-full border border-sage-200 bg-ivory-100 px-3 py-1 text-[11px] text-sage-700 transition hover:bg-sage-100 active:scale-95"
                  >
                    <Icon name="instagram" size={12} />
                    <span>@{WEDDING.groom.instagram}</span>
                  </a>
                </figcaption>
              </figure>
            </Reveal>
        ...
        <section className="bg-offwhite px-5 py-12">
          <Reveal>
            <div className="mb-8 text-center">
              ...
              <p className="mx-auto mt-2 max-w-xs text-xs text-sage-600">
        ...
        >
          <p className="mb-4 text-xs font-medium tracking-[3px] text-sage-100 uppercase">
          ...
          <div className="flex justify-center gap-4">
            <a
              ...
              className="flex h-11 w-11 items-center justify-center rounded-full bg-white/90 text-[10px] font-bold text-sage-700 shadow-lg transition hover:scale-105 active:scale-95"
            >
              WA
            </a>
            <a
              href={WEDDING.contactMapUrl}
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Buka lokasi peta"
              className="flex h-11 w-11 items-center justify-center rounded-full bg-white/90 text-sage-700 shadow-lg transition hover:scale-105 active:scale-95"
            >
